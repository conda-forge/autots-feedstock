...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/autots-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14956&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/autots-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `autots` can be installed with:

```
conda install autots
```

It is possible to list all of the versions of `autots` available on your platform with:
